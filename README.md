# FHNW XAI Training Center

This is the training center for the explainable AI bachelor's course at FHNW. The training center comprises exercises for three types of data modalities; tabular, text, and image.  
